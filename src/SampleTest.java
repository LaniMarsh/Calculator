...
public class SampleTest {
    ...
    public void testSampleFile() {
        ...
        assertEquals("1 + 2 = 3\n" +
                "3 * 5 = 15\n" +
                "0 * 1 = 0\n" +
                "123412341234 + 876587658765 = 999999999999\n" +
                "0 * 10 = 0\n" +
                "79000000000000 + 1 = 79000000000001\n" +
                "5108577068 + 5108577068 = 10217154136\n" +
                "79000000000000 * 1 = 79000000000000\n" +
                "5108577068 * 5108577068 = 26097559659695476624\n" +
                "999789001 * 119920 = 119894696999920", output);
    }
